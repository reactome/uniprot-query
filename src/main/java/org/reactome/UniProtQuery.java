...
//    public static void executeTrEMBLIdQuery() {
//        Iterator<List<String>> tremblIDBatchIterator = TrEMBLQuery.getTrEMBLIDBatchIterator();
//        while (tremblIDBatchIterator.hasNext()) {
//            List<String> tremblIDBatch = tremblIDBatchIterator.next();
//            System.out.println(tremblIDBatch);
//        }
//    }

//    public static void submitMappingJob() throws IOException {
//        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
//            HttpPost httpPost = new HttpPost(uniProtRESTURL);
//            httpPost.setHeader("Content-type", "multipart/form-data");
//            String postData = "ids=\"P21802\";from=\"UniProtKB_AC-ID\";to=\"KEGG\"";
//
...
//        HttpsURLConnection httpURLConnection = (HttpsURLConnection) new URL(uniProtRESTURL).openConnection();
...
//
//
//        PrintWriter outputStream = new PrintWriter(new OutputStreamWriter(httpURLConnection.getOutputStream(),"UTF-8"),true);
//        //outputStream.write("ids=P21802&from=UniProtKB_AC-ID&to=KEGG".getBytes());
//        outputStream.append("--" + boundary);
//        outputStream.append(System.lineSeparator());
//        outputStream.append("Content-Disposition: form-data; name=\"ids\"");
//        outputStream.append(System.lineSeparator());
//        outputStream.append("Content-Type: text/plain; charset=UTF-8");
//        outputStream.append(System.lineSeparator());
//        outputStream.append(System.lineSeparator() );
//        outputStream.append("P21802");
//        outputStream.append(System.lineSeparator());
//        outputStream.flush();
//
//
//        outputStream.append("--" + boundary);
//        outputStream.append(System.lineSeparator());
//        outputStream.append("Content-Disposition: form-data; name=\"from\"");
//        outputStream.append(System.lineSeparator());
//        outputStream.append("Content-Type: text/plain; charset=UTF-8");
//        outputStream.append(System.lineSeparator());
//        outputStream.append(System.lineSeparator() );
//        outputStream.append("UniProtKB_AC-ID");
//        outputStream.append(System.lineSeparator());
//        outputStream.flush();
//
//        outputStream.append("--" + boundary);
//        outputStream.append(System.lineSeparator());
//        outputStream.append("Content-Disposition: form-data; name=\"to\"");
//        outputStream.append(System.lineSeparator());
//        outputStream.append("Content-Type: text/plain; charset=UTF-8");
//        outputStream.append(System.lineSeparator());
//        outputStream.append(System.lineSeparator() );
//        outputStream.append("KEGG");
//        outputStream.append(System.lineSeparator());
//        outputStream.flush();
//
//        outputStream.close();
//        //httpURLConnection.setRequestProperty("ids", "P21802");
//        //httpURLConnection.setRequestProperty("from", "UniProtKB_AC-ID");
//        //httpURLConnection.setRequestProperty("to", "KEGG");
//
